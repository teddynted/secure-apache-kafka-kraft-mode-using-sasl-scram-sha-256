...
sudo sed -i s/controller.quorum.voters=1@localhost:9093/controller.quorum.voters=1@$PRIVATE_DNS_NAME_NODE_1:9093,2@$PRIVATE_DNS_NAME_NODE:9093,3@$PRIVATE_DNS_NAME_NODE_3:9093/ /opt/kafka/config/kraft/server.properties
