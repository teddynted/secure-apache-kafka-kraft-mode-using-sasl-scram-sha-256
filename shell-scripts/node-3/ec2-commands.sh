...
CERT="/opt/kafka/config/kafka-ssl/kafka-certs/node-3"
...
sudo sed -i s/controller.quorum.voters=1@localhost:9093/controller.quorum.voters=1@$6:9093,2@$7:9093,3@$4:9093/ /opt/kafka/config/kraft/server.properties
