...
sudo sed -i s/listeners=PLAINTEXT:\\/\\/:9092,CONTROLLER:\\/\\/:9093/listeners=SASL_SSL:\\/\\/$IP_ADDRESS:9092,CONTROLLER:\\/\\/$IP_ADDRESS:9093/ /opt/kafka/config/kraft/server.properties
