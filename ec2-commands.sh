...
sudo sed -i s/advertised.listeners=PLAINTEXT:\\/\\/localhost:9092,CONTROLLER:\\/\\/localhost:9093/advertised.listeners=CLIENT:\\/\\/$PUBLIC_DNS_NAME:9092,CONTROLLER:\\/\\/$PRIVATE_DNS_NAME:9093,BROKER:\\/\\/$PRIVATE_DNS_NAME:9094/ /opt/kafka/config/kraft/server.properties
